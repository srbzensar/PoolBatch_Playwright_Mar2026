...
test('Create a New Post using Data from JSON File_sync', async ({ request }) => {
...
test('Create a New Post using Data from JSON File_async', async ({ request }) => {

    const url = 'https://jsonplaceholder.typicode.com/posts';

    // Read JSON data from file asynchronously
    const filePath = 'files/newPostData.json';
    const newPostPayload = JSON.parse(await fs.promises.readFile(filePath, 'utf-8'));
